...
const AudioPlayer = ({ audioSrc, id, display, on, volume, text, isActive }) => {
  ...
  return /*#__PURE__*/ React.createElement(
    "button",
    {
      className: "",
      id: text,
      className: `drum-pad btn btn-warning m-1 ${isActive ? "active" : ""}`,
      onClick: playAudio,
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        null,
        /*#__PURE__*/ React.createElement("p", null, " Power")
      ) /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "form-check form-switch" } /*#__PURE__*/,
      ...
      React.createElement(
        ...
        {
          className:
            "  text-light d-flex align-items-center text-center justify-content-center m-4",
          style: { width: "100%", height: "40px", backgroundColor: "#004643" },
          id: "display",
        },
        props.text
      ) /*#__PURE__*/,
...
const Drum = () => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    React.createElement(
      "div",
      {
        className: "container row p-5 rounded-3",
        id: "drum-machine",
        style: { backgroundColor: "#abd1c6" },
      } /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "col" } /*#__PURE__*/,
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            audioFiles.map((audioFile, index /*#__PURE__*/) =>
              React.createElement(
                "div",
                { key: index, className: "col-4" } /*#__PURE__*/,
                React.createElement(AudioPlayer, {
                  ...
                  isActive: buttonStatus[audioFile.id],
                })
              )
            )
          )
      ...
      React.createElement(
        "div",
        { className: "col", id: "display" } /*#__PURE__*/,
